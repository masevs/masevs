...
## 📚 Related Paper
This notebook accompanies my paper:  
_"Performance Complexity in NCT 127: Quantifying and Modeling Musical Hardness Using Audio Features and Spectrogram-Based Learning"_  
Submitted to [TISMIR / other].
